...
$default_master_rows = [
    ['is_label_row' => 'Y', 'timer_setting' => 'STD REF', 'r1' => '', 'd1' => '', 'r2' => '', 'd2' => '', 'r3' => '', 'd3' => '', 'remarks_1' => '', 'remarks_2' => '', 'remarks_3' => ''],
    ['is_label_row' => 'N', 'timer_setting' => '',         'r1' => '', 'd1' => '', 'r2' => '', 'd2' => '', 'r3' => '', 'd3' => '', 'remarks_1' => '', 'remarks_2' => '', 'remarks_3' => ''],
    ['is_label_row' => 'N', 'timer_setting' => '',         'r1' => '', 'd1' => '', 'r2' => '', 'd2' => '', 'r3' => '', 'd3' => '', 'remarks_1' => '', 'remarks_2' => '', 'remarks_3' => ''],
];
                                ...
                                <tbody id="masterTimerBody">
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space:normal; min-width:180px; text-align:left;">
                                            <input type="text" name="master_remarks_1[]" class="form-control form-control-sm mb-1" placeholder="Remark 1" value="<?= htmlspecialchars($mr['remarks_1'] ?? ''); ?>" <?= $is_view_only ? 'readonly' : ''; ?>>
                                            <input type="text" name="master_remarks_2[]" class="form-control form-control-sm mb-1" placeholder="Remark 2" value="<?= htmlspecialchars($mr['remarks_2'] ?? ''); ?>" <?= $is_view_only ? 'readonly' : ''; ?>>
                                            <input type="text" name="master_remarks_3[]" class="form-control form-control-sm"     placeholder="Remark 3" value="<?= htmlspecialchars($mr['remarks_3'] ?? ''); ?>" <?= $is_view_only ? 'readonly' : ''; ?>>
                                        </td>
                                        <?php if (!$is_view_only): ?>
                                        <td>
                                            <?php if (($mr['is_label_row'] ?? 'N') !== 'Y'): ?>
...
$(document).ready(function () {
    ...
    $("#addRowBtn").click(function () {
        ...
        <tr>
            ...
            <td style="white-space:normal; min-width:180px; text-align:left;">
                <input type="text" name="master_remarks_1[]" class="form-control form-control-sm mb-1" placeholder="Remark 1">
                <input type="text" name="master_remarks_2[]" class="form-control form-control-sm mb-1" placeholder="Remark 2">
                <input type="text" name="master_remarks_3[]" class="form-control form-control-sm"     placeholder="Remark 3">
            </td>
