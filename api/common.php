...
class Common
{
    ...
    public static function pdf_generate($record_id = '', $type = 'I')
    {
        ...
        <style>
            ...
            .not-yet { color: #ffffff; font-style: italic; }
            .audit-bar {
                font-size: 9px;
                color: #ffffff;
                background: #f8f8f8;
        ...
        <table>
            <tr>
                <td width="70%">
                    ...
                    <table>
                <tr>
                    <td style="width:100px; padding:0;">Document No.:</td>
                    <td style="padding:0;">QP-08-CTC</td>
                </tr>
                <tr>
                    <td style="padding:0;">Revision:</td>
                    <td style="padding:0;">3</td>
                </tr>
                <tr>
                    <td style="padding:0;">Effective Date:</td>
                    <td style="padding:0;">15/01/26</td>
                </tr>
            </table>
                </td>
